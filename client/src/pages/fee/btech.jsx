    ...
    <div>
      ...
      >
        ...
        <div className='p-3 max-w-lg mx-auto'>
          ...
          <select id="branchselect" type='text' className='border p-1 px-5 rounded-lg opacity-90 focus:outline-none' onChange={handleChange}
            value={formData.branchselect} required>
